...
class ResNet34Unet(object):
    def __init__(self, input_shape=[128, 128, 3], name='resnet-34-unet'):
        self.model = self.get_model(input_shape = input_shape, name=name)  

    def get_model(self, input_shape=(None, None, 3), classes=1, decoder_filters=16, decoder_block_type='upsampling',
